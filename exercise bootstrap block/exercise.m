...
% 7.2. Draw samples of k blocks from the original sample and compute the sample mean each time
for i = 1:N_sim
...
% 8.1. Preallocate vector to store sample means
